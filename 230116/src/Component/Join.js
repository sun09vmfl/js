...
function Join() {
  ...
  const check = value => {
    ...
    // userPw1
    if (value.userPw1 < 5 || !eng.test(value.userPw1) || !num.test(value.userPw1) || !enti.test(value.userPw1)) {
      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div className="row">
            ...
            <input type="password" name="userPw1" id="userPw1" placeholder="비밀번호를 입력하세요" onChange={handleChange} />
            <p className="errMsg">{Err.userPw1}</p>
          </div>
          <div className="row">
            <label htmlFor="userPw2">비밀번호 확인</label>
            <input type="password" name="userPw2" id="userPw2" placeholder="비밀번호를 입력하세요" onChange={handleChange} />
          ...
          <div className="row">
            ...
            <input type="email" name="userEmail" id="userEmail" placeholder="이메일을 입력하세요" value={val.userEmail} onChange={handleChange} />
          ...
          <div className="row inline">
            ...
            <input type="checkbox" name="interest" id="html5" onChange={handleCheck} />
            <label htmlFor="css3">css3</label>
            <input type="checkbox" name="interest" id="css3" onChange={handleCheck} />
            <label htmlFor="javascript">javascript</label>
            <input type="checkbox" name="interest" id="javascript" onChange={handleCheck} />
            <label htmlFor="react">react</label>
            <input type="checkbox" name="interest" id="react" onChange={handleCheck} />
